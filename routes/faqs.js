...
router.post('/seed', auth, async (req, res) => {
  try {
    ...
    const defaults = [
      { question: 'Who can apply for a Salary Topup loan?', answer: 'Any salaried individual aged 21–58 years with a minimum monthly income of ₹15,000 can apply. You need to be working with your current employer for at least 3 months.', group: 'Eligibility & Amount', order: 1, active: true, showOnHome: true },
      ...
      { question: 'Do I need to provide any collateral?', answer: 'No, Salary Topup loans are completely unsecured. You don\'t need to pledge any asset or provide any collateral. Your salary is your credit.', group: 'General', order: 3, active: true, showOnHome: true },
